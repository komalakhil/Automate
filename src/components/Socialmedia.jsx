...
function Socialmedia() {
  ...
  // var [matter,setMatter] = useState(true);
  const submiticon = (
    <svg
    ...
    <div className="border border-dashed rounded px-2">
        <div className="flex flex-row space-x-7 mt-3">
          <div className="flex flex-row space-x-3">
            ...
            <select className="select select-bordered font-sans bg-white text-black h-3 w-6/12">
              <option>
                Pick one
              </option>
          ...
          <div className="flex flex-row space-x-1">
            ...
            <select className="select select-bordered font-sans bg-white text-black h-5 w-6/12">
              <option>
                Pick one
              </option>
              {volunteer && volunteer.map((volunteer)=>(
        ...
        <div className="flex flex-row space-x-9 mt-8">
          <div className="flex flex-row space-x-5">
            ...
            <select className="select select-bordered font-sans bg-white text-black h-5 w-36">
              <option>
                Pick one
              </option>
              {volunteer && volunteer.map((volunteer)=>(
